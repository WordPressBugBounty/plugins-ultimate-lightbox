...
<a href="https://www.etoilewebdesign.com/ultimate-lightbox/" target="_blank">Ultimate Lightbox Demo</a>
...
<strong>Works with Gutenberg, for both galleries and single images!</strong>
...
= 0.22 =
- <strong>This is a big update with several new features, corrections, revised admin styling, etc., so please take caution and test before updating on a live site (or wait a few days before updating in case some minor corrective updates need to be put out)</strong>
